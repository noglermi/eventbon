...
export const printerProfiles: PrinterProfile[] = [
  {
    ...
    installationGuide: {
      de: [
        "Brother TD-4000 per USB anschliessen und einschalten.",
        "Brother Windows-Treiber installieren.",
        "58 x 60 mm Medium einlegen.",
        "QZ Tray starten und Drucker in EventBon auswaehlen.",
        "EventBon-Testbon drucken und Schnitt pruefen.",
      ],
      en: [
    ...
    knownNotes: {
      de: ["Fixes 58 x 60 mm Medium.", "Schnitt erfolgt ueber Windows/Brother-Treiber an Job-Grenzen."],
  ...
  },
  {
    ...
    connectionOptions: ["USB", "LAN abhaengig vom Modell"],
    hasCutter: true,
    supportedPlatforms: ["Windows"],
    ...
    installationGuide: {
      de: [
        "Drucker erst nach Lieferung physisch pruefen.",
        "Windows-Druckertreiber installieren.",
        "80-mm-Papierrolle einlegen.",
        "QZ Tray starten und Drucker in EventBon auswaehlen.",
        "EventBon-Testbon inklusive Umlauten, Eurozeichen und Cutter pruefen.",
      ],
      en: [
    ...
    testedEventBonVersion: null,
    knownNotes: {
      de: ["Noch keine erfolgreiche EventBon-Installation oder Druckkompatibilitaet behaupten.", "ESC/POS-Kompatibilitaet erst nach Test bestaetigen."],
    ...
    recommendedSettings: {
      de: ["80 mm Papierbreite", "QZ Tray vorgesehen", "Cutter nach Praxistest pruefen"],
  ...
  },
  {
    ...
    status: "supported",
    description: {
      de: "Generisches 58-mm-Profil fuer einfache Bon-Drucker.",
    ...
    installationGuide: { de: ["Windows-Druckertreiber installieren.", "Papierbreite 58 mm pruefen.", "Testbon drucken."], en: ["Install Windows printer driver.", "Check 58 mm paper.", "Print test voucher."] },
    testStatus: { de: "Unterstuetztes generisches Profil, kein zertifiziertes Modell.", en: "Supported generic profile, no certified model." },
    lastTestedAt: null,
    testedEventBonVersion: null,
    knownNotes: { de: ["Nur generisches Fallback-Profil."], en: ["Generic fallback profile only."] },
    recommendedSettings: { de: ["58 mm Papierbreite", "Browserdruck als Fallback"], en: ["58 mm paper width", "Browser print fallback"] },
    qzPrinterHints: [],
    active: true,
    paperWidthMm: 58,
    density: "compact",
  ...
  },
  {
    ...
    status: "supported",
    description: {
      de: "Generisches 80-mm-Profil fuer Thermobondrucker.",
    ...
    requiredSoftware: ["Windows printer driver"],
    driverHint: { de: "Drucker in Windows installieren.", en: "Install the printer in Windows." },
    installationGuide: { de: ["Windows-Druckertreiber installieren.", "Papierbreite 80 mm pruefen.", "Testbon drucken."], en: ["Install Windows printer driver.", "Check 80 mm paper.", "Print test voucher."] },
    testStatus: { de: "Unterstuetztes generisches Profil, kein zertifiziertes Modell.", en: "Supported generic profile, no certified model." },
    lastTestedAt: null,
    testedEventBonVersion: null,
    knownNotes: { de: ["Nur generisches Fallback-Profil."], en: ["Generic fallback profile only."] },
  ...
  },
  {
    ...
    status: "testing_pending",
    description: { de: "Zukuenftiger Epson-Profilpfad, noch nicht zertifiziert.", en: "Future Epson profile path, not certified yet." },
    printerType: "receipt",
    connectionOptions: ["USB", "LAN"],
    hasCutter: true,
    supportedPlatforms: ["Windows"],
    ...
    lastTestedAt: null,
    testedEventBonVersion: null,
    knownNotes: { de: ["Noch nicht fuer den produktiven Einsatz freigegeben."], en: ["Not released for production use yet."] },
    recommendedSettings: { de: ["Nach Zertifizierung ergaenzen."], en: ["Add after certification."] },
  ...
  },
  {
    ...
    status: "testing_pending",
    description: { de: "Zukuenftiger Star-Profilpfad, noch nicht zertifiziert.", en: "Future Star profile path, not certified yet." },
    printerType: "receipt",
    connectionOptions: ["USB", "LAN"],
    hasCutter: true,
    supportedPlatforms: ["Windows"],
