    ...
    <footer className="rounded-lg bg-white/80 p-4 text-sm font-bold leading-6 text-slate-600 ring-1 ring-slate-200">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p>{isGerman ? "iPad, Android und weitere Drucker folgen spaeter." : "iPad, Android, and additional printers will follow later."}</p>
          <p>{isGerman ? "Supportkontakt: TODO Support-E-Mail." : "Support contact: TODO support email."}</p>
        </div>
