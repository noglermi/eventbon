...
const numpadButtonBaseClass = "flex min-h-16 items-center justify-center rounded-2xl text-2xl font-black tracking-normal shadow-[inset_0_-3px_0_rgba(15,23,42,0.22),0_10px_20px_rgba(15,23,42,0.12)] ring-1 transition active:scale-95 focus:outline-none focus-visible:ring-4 focus-visible:ring-emerald-200";
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-5">
        ...
        <div className="rounded-[1.75rem] bg-white p-5 shadow-sm ring-1 ring-slate-300/90">
          ...
          <input
            ...
            className="mt-3 w-full rounded-2xl bg-white px-4 py-4 text-5xl font-black tabular-nums text-slate-950 shadow-inner outline-none ring-2 ring-slate-300 transition placeholder:text-slate-400 focus:ring-4 focus:ring-emerald-200"
        ...
        <div className="mt-5 grid grid-cols-3 gap-3">
          ...
          <button type="button" onClick={clearAmount} className={numpadButtonBaseClass + " col-span-3 bg-rose-50 text-rose-800 ring-rose-200 hover:bg-rose-100 active:bg-rose-100 focus-visible:ring-rose-200"} aria-label={language === "de" ? "Betrag l\u00f6schen" : "Clear amount"}>C</button>
        </div>
